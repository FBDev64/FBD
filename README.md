...
A special thanks to all members of [@charmbracelet](https://github.com/charmbracelet), for developing Gum, and helping me debug `fbd.sh` and probably other code. A big big thanks.
**Not Sponsored**.
